...
Buat repository baru di GitHub dengan format nama ``` sacode-e-commerse-project09-namadepan ```
...
```
git clone https://github.com/username/sacode-e-commerse-project09-namadepan.git
```
